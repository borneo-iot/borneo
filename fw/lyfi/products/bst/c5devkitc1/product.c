...
const struct led_factory_settings LED_FACTORY_DEFAULT_SETTINGS = {
    ...
    .channels = {
        { .name = "CW", .color = "#78909C", .wavelength = 0, .factor = 0.16666 },
        { .name = "RB", .color = "#5C6BC0", .wavelength = 0, .factor = 0.16666 },
        { .name = "B", .color = "#42A5F5", .wavelength = 0, .factor = 0.16666 },
        { .name = "R", .color = "#EF5350", .wavelength = 0, .factor = 0.16666 },
        { .name = "G", .color = "#66BB6A", .wavelength = 0, .factor = 0.16666 },
        { .name = "VUV", .color = "#AB47BC", .wavelength = 0, .factor = 0.16666 },
    },
};
